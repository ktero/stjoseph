                          ...
                          <div class="row">
                              <div class="col-lg-6">
                                <?php
                                    ...
                                    $query= "SELECT * FROM school_year WHERE ID = '$edit_key'";
                                    $result= mysqli_query($conn, $query) or die ('Error: '.mysqli_error($conn));


                                    echo "<form action='updateSY_form.php' method='post'>";
                                        ...
                                        if (mysqli_num_rows($result)>0)
                                        {
                                            ...
                                            echo "<div class='form-group'>
                                                    ...
                                                    <input name='schoolyear' class='form-control' value='".$row[1]."' data-validation-required-message>
                                                </div>";
                                            }
                                        }
                                        else
