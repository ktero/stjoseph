			...
			echo "<ol>";
				if (mysql_num_rows($result)>0)
				{
					while($row = mysql_fetch_row($result))
					{
						...
						<a href='edit_student.php?studentedit_key=$row[0]' class='btn btn-default' style='background-color: lightblue'> Edit </a>";
					}
				}
			else
			{
				echo "<div class='page-wrapper' align='Center' style='padding:50px'>";
				echo "<h1>Student Record Not Found</h1>";
				echo "<a href='formedit_student.html' class='btn btn-default' role='button' style='background-color: lightblue; text-align: right'>Search Again</a>";
				echo "</div>";
			}
			echo "</ol>";
